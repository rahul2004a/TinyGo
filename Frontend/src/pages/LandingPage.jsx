        ...
        <div className="min-h-[calc(100vh-64px)]  lg:px-14 sm:px-8 px-4">
            <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
                <div className=" flex-1">
                    ...
                    >
                        TinyGo makes URL shortening simple and efficient for seamless sharing.
                    </motion.h1>
                    <p className="text-slate-700 text-sm my-5">
                        TinyGo streamlines the process of URL shortening, making link sharing effortless and efficient. With its user-friendly interface, TinyGo lets you generate concise, easy-to-share URLs in just seconds.
                        Simplify your sharing experience — choose TinyGo today.
                    </p>
